...
const KEY_GPT = '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';
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.form}>
        ...
        <TextInput placeholder='Ex: Mogi Guaçu, SP' style={styles.input} value={city} onChangeText={(text) => setCity(text)} />

        <Text style={styles.label}>Tempo de estadia: <Text style={styles.days}> {days.toFixed(0)} </Text> dias</Text>git 
        <Slider 
          minimumValue={1}
          maximumValue={7}
